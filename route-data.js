...
window.ROUTE_DATA = {
  ...
  "landmarks": [
    ...
    { "id": "beach",       "order": 5,  "scale": "human", "label": "The Beach",       "art": "illustrated", "pace": 2.6, "note": "Arrival point. Daylight. The character is here. The edge into it is paced slow on purpose - it has to read as coming out of a head, and at ordinary speed it read as an ordinary zoom." },
    ...
    { "id": "atmosphere",  "order": 11, "scale": "planetary", "label": "The Atmosphere", "art": "abstract", "move": "climb", "note": "Reached by going straight up off the Flatirons - a pure vertical launch, no zoom. The ground is gone; the limb glows below and there is nothing else here but thin air and the one sim that is about this air. The top of the launch, not a destination." },
