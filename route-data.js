...
window.ROUTE_DATA = {
  ...
  "sims": [
    ...
    { "slug": "xray-diffraction", "name": "X-Ray Diffraction", "landmark": "electron-shell", "order": 9, "topic": "waves-light", "also": ["matter"] , "phet": { "kind": "unpublished" } },
    ...
    { "slug": "optics-lab", "name": "Optics Lab", "landmark": "lighthouse", "order": 3, "topic": "waves-light", "also": [] , "phet": { "kind": "unpublished" } },
    ...
    { "slug": "circuit-construction-kit-black-box-study", "name": "CCK: Black Box Study", "landmark": "city", "order": 8, "topic": "electromagnetism", "also": [], "variantOf": "circuit-construction-kit-dc", "variantKind": "black-box" , "phet": { "kind": "unpublished" } },
