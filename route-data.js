...
window.ROUTE_DATA = {
  "meta": {
    ...
    "thumbLocalTemplate": "assets/thumbs/{slug}.png",
    ...
    "notes": [
      ...
      "assets/thumbs/ holds a local 240x158 copy of every published screenshot (2.2 MB, 87 files) so the route renders with no network. The 600px original is the upgrade path for an expanded sim card.",
      ...
      "Every sim slot is a link that opens the sim at phet.colorado.edu in a new tab. Nothing cross-origin is ever embedded in the page, which is also the whole answer to the modal-trap problem an in-page iframe would have had.",
